...
url = 'postgresql+psycopg2://alexfigueroa-db-user:pw@alexfigueroa-postgres:5432/alexfigueroa'
config = context.config
config.set_main_option('sqlalchemy.url', url)

from sqlalchemy_models.base import Base  # type: ignore # Replace 'myapp.models' with the actual path to your models
